      ...
      <b-card no-body class="shadow-sm">
        <b-card-body class="pt-3">
          <div>
            ...
            <a class="float-right" href="/account">
                Account <font-awesome-icon icon="chevron-right" />
            </a>
          </div>
    ...
    <b-card no-body class="mt-4 shadow-sm">
      <b-card-body class="pt-3">
        <div>
          ...
          <a class="float-right pt-2" href="/projects">
            All Projects <font-awesome-icon icon="chevron-right" />
        </a>
        </div>
        <b-card-group deck>
          <!--
            no-body is necessary for proper formatting of footer.
            Body is manually added later.
          -->
    ...
    <b-card no-body class="mt-4 shadow-sm">
      <b-card-body class="pt-3">
        <div>
          ...
          <a class="float-right pt-2" href="/projects">
            All Datasets <font-awesome-icon icon="chevron-right" />
          </a>
        </div>
        <b-card-group deck>
          <b-card img-src="https://picsum.photos/300/300/?image=41" img-alt="Image" img-top no-body>
