...
const getProductionConfig = () => {
  ...
  const overrideBaseURLTemplate = {
    chainWebpack: (config) => {
      config.plugin("html").tap((args) => {
        ...
        const original = firstArg.templateParameters;
        firstArg.templateParameters = (compilation, assets, pluginOptions) => Object.assign(
  ...
  return { // enable sub-resource integrity check as our executables are deployed on other's infra
